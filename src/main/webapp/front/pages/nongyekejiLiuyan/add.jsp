...
<!-- text后缀 -->
            <div class="layui-form-item main_borderColor" :style='{"padding":"10px","boxShadow":"0 0 0px rgba(255,0,0,.8)","margin":"0 0 10px 0","backgroundColor":"rgba(255, 255, 255, 0)","borderRadius":"1px","borderWidth":"0 0 1px 0","borderStyle":"solid"}'>
                ...
                <div class="layui-input-block">
                    <textarea class="main_borderColor layui-input" style="width: 100%;height: 100px;border-radius: 5px;padding: 10px" v-model="detail.nongyekejiLiuyanText" lay-verify="required" :readonly="ro.nongyekejiLiuyanText" name="nongyekejiLiuyanText" id="nongyekejiLiuyanText" autocomplete="off"></textarea>
                </div>
            </div>
    <!-- text后缀 -->
            <div class="layui-form-item main_borderColor" :style='{"padding":"10px","boxShadow":"0 0 0px rgba(255,0,0,.8)","margin":"0 0 10px 0","backgroundColor":"rgba(255, 255, 255, 0)","borderRadius":"1px","borderWidth":"0 0 1px 0","borderStyle":"solid"}'>
    ...
    <script>
        ...
        layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
            ...
            localStorage.setItem("goUtl","./pages/nongyekejiLiuyan/list.jsp")
           ...
           // 上传文件
            ...
            //修改
            if(http.getParam('nongyekejiLiuyanId')){
                http.request(`nongyekejiLiuyan/info/${http.getParam('nongyekejiLiuyanId')}`, 'get', {}, function(data) {
            ...
            form.on('submit(thisSubmit)', function (data) {
                ...
                if(http.getParam('nongyekejiLiuyanId')){
                    data["id"]= http.getParam('nongyekejiLiuyanId')
                }
                // 提交数据
                http.requestJson(`nongyekejiLiuyan/${http.getParam("nongyekejiLiuyanId")?"update":"add"}`, 'post', data, function (res) {
                    if(res.code == 0){
                        layer.msg('提交成功', {
                            time: 2000,
                            icon: 6
                        }, function () {
                            vue.jump("../nongyekejiLiuyan/list.jsp");
                                http.remove('nongyekejiLiuyanId')
                            // back();
                        });
                    }else{
                        layer.msg(res.msg, {
