...
*/
@TableName("nongyekeji_collection")
public class NongyekejiCollectionView extends NongyekejiCollectionEntity implements Serializable {
	...
	*/
	...
	private String nongyekejiCollectionValue;
	...
	public NongyekejiCollectionView() {

	}

	public NongyekejiCollectionView(NongyekejiCollectionEntity nongyekejiCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, nongyekejiCollectionEntity);
	...
	* 获取： 类型的值
	*/
	public String getNongyekejiCollectionValue() {
		return nongyekejiCollectionValue;
	}
	/**
	* 设置： 类型的值
	*/
	public void setNongyekejiCollectionValue(String nongyekejiCollectionValue) {
		this.nongyekejiCollectionValue = nongyekejiCollectionValue;
	}
	...
	public String toString() {
		return "NongyekejiCollectionView{" +
			", nongyekejiCollectionValue=" + nongyekejiCollectionValue +
