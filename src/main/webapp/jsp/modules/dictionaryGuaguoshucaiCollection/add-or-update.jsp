...
<script>
    ...
    var tableName = "dictionaryGuaguoshucaiCollection";
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            data["dicCode"] = "guaguoshucai_collection_types";
            data["dicName"] = "收藏表类型";
    ...
    function getDetails() {
        ...
        if (adddictionary != null && adddictionary != "" && adddictionary != "null") {
            ...
            $(validform());
            $('#submitBtn').text('新增');
            httpJson("dictionary/maxCodeIndex" , "POST", {"dicCode":"guaguoshucai_collection_types"}, (res) => {
                if(res.code == 0){
