...
public class ChuqinyangzhiCollectionEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public ChuqinyangzhiCollectionEntity() {

	}

	public ChuqinyangzhiCollectionEntity(T t) {
		try {
    ...
    public String toString() {
        return "ChuqinyangzhiCollection{" +
            ", id=" + id +
            ", chuqinyangzhiId=" + chuqinyangzhiId +
            ", yonghuId=" + yonghuId +
            ", chuqinyangzhiCollectionTypes=" + chuqinyangzhiCollectionTypes +
