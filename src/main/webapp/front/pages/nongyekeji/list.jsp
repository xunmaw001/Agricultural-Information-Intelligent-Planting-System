...
<div class="item-list">
    ...
    <input type="text" v-model="searchForm.nongyekejiName"
           ...
           class="layui-input">
                ...
                <button v-if="isAuth('nongyekeji','新增')"
                        @click="jump('../nongyekeji/add.jsp')"
                    ...
                    <div>
                        <div style="display: flex;flex-wrap: wrap;">
                            <div v-for="(item,index) in dataList" class="list-item4 list-item3B">
                                <a @click="jumpCheck('../nongyekeji/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)" style="margin-top:0;">
                                    <div class="hovereffect">
                                        <img :src="item.nongyekejiPhoto?baseUrl+item.nongyekejiPhoto.split(',')[0]:''" alt="" style="display: block;position: relative;width:250px;height: 280px;" />
                                        <div class="overlay">
                                            <p class="info">{{item.nongyekejiName}}</p>
                                        </div>
                                    </div>
                                </a>
                            </div>
