...
<div id="app">
    ...
    <div class="forum-container">
               <div :style='{"padding":"0","boxShadow":"0 0 6px rgba(255,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,1)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"10px","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}'>
                   <div style="display: inline-block;text-align: center;cursor: pointer;"
                        ...
                        :style='forumTypes==-1?{"padding":"0 10px","boxShadow":"0 0 6px rgba(0,0,0,.3)","margin":"0 10px 0 0","borderColor":"rgba(0,0,0,1)","color":"#fff","borderRadius":"10px","borderWidth":"0","width":"110px","lineHeight":"34px","fontSize":"14px","borderStyle":"solid"}:{"padding":"0 10px","boxShadow":"0 0 6px rgba(0,0,0,.3)","margin":"0 10px 0 0","borderColor":"rgba(0,0,0,1)","backgroundColor":"#fff","color":"#333","borderRadius":"10px","borderWidth":"0","width":"110px","lineHeight":"34px","fontSize":"14px","borderStyle":"solid"}'>
                       全部
                   </div>
                   <div class="category-search main_backgroundColor" :index="item.codeIndex"
                        :style='forumTypes==item.codeIndex?{"padding":"0 10px","boxShadow":"0 0 6px rgba(0,0,0,.3)","margin":"0 10px 0 0","borderColor":"rgba(0,0,0,1)","color":"#fff","borderRadius":"10px","borderWidth":"0","width":"110px","lineHeight":"34px","fontSize":"14px","borderStyle":"solid"}:{"padding":"0 10px","boxShadow":"0 0 6px rgba(0,0,0,.3)","margin":"0 10px 0 0","borderColor":"rgba(0,0,0,1)","backgroundColor":"#fff","color":"#333","borderRadius":"10px","borderWidth":"0","width":"110px","lineHeight":"34px","fontSize":"14px","borderStyle":"solid"}'
    ...
    <el-dialog title="发布帖子" :visible.sync="dialogFormVisible" class="demo-ruleForm">
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm">
            ...
            <el-form-item label="帖子类型" :label-width="formLabelWidth" prop="forumTypes">
                <el-select v-model="ruleForm.forumTypes" placeholder="帖子类型">
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery'], function() {
        ...
        vue.pageList()
            ...
            jquery(document).on("click", ".category-search", function (e) {
                vue.forumTypes = jquery(this).attr('index')
                //获取的是下标
                //vue.forumTypes
                vue.pageList(vue.forumTypes);
            });
    });
</script>
</body>
