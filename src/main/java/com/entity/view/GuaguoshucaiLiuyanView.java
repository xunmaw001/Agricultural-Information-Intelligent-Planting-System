...
public class GuaguoshucaiLiuyanView extends GuaguoshucaiLiuyanEntity implements Serializable {
	...
	public GuaguoshucaiLiuyanView() {

	}

	public GuaguoshucaiLiuyanView(GuaguoshucaiLiuyanEntity guaguoshucaiLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, guaguoshucaiLiuyanEntity);
