...
public class ShuichanyangzhiView extends ShuichanyangzhiEntity implements Serializable {
	...
	*/
	...
	public ShuichanyangzhiView() {

	}

	public ShuichanyangzhiView(ShuichanyangzhiEntity shuichanyangzhiEntity) {
		try {
			BeanUtils.copyProperties(this, shuichanyangzhiEntity);
	...
	*/
	...
	public String toString() {
		return "ShuichanyangzhiView{" +
			", shuichanyangzhiValue=" + shuichanyangzhiValue +
