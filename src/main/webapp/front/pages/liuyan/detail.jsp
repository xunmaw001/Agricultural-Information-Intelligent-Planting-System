    ...
    <div id="app">
        ...
        <div class="news-container">
            ...
            <div style="width: 980px;margin: 0 auto">
                <img width="100%" :src="baseUrl+detail.liuyanPhoto">
            </div>
            <div class="content" style="word-break: break-all;" v-html="myFilters(detail.liuyanContent)">
            </div>
    ...
    <script>
        ...
        var vue = new Vue({
            ...
            methods: {
                //分享
                share(){
                    let element = createElement("http://localhost:8080/zhinenghuazhongzhi/front/index.jsp?url="+"./pages/liuyan/detail.jsp?id="+this.id);
                    element.select();
        ...
        layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery', 'laypage', 'util'], function () {
            ...
            localStorage.setItem("goUtl","./pages/liuyan/detail.jsp?id="+ http.getParam('id'))
            ...
            vue.detail.id = id;
            // 详情信息
            http.request('liuyan/detail/' + id, 'get', {}, function(res) {
                vue.detail = res.data;
