...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">土壤肥料管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">土壤肥料列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">土壤肥料列表</h3>
                            <div class="table-responsive mb-3" id="tableDiv">
                                <div class="col-sm-12">
                                        ...
                                        <label>土壤肥料类型</label>
                                        <select name="turangfeiliaoTypesSelectSearch" id="turangfeiliaoTypesSelectSearch" aria-controls="tableId" class="form-control form-control-sm"></select>
                                        ...
                                        <span class="导入导出">导入<input name="file" id="turangfeiliaoExcelFile" type="file" class="btn btn-success" style="width: 70px!important; line-height: 35px;"></span>
                                ...
                                <table id="tableId" class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <th onclick="sort('turangfeiliao_name')">土壤肥料标题<i id="turangfeiliaoNameIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('turangfeiliao_uuid_number')">土壤肥料编号<i id="turangfeiliaoUuidNumberIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('turangfeiliao_photo')">土壤肥料照片<i id="turangfeiliaoPhotoIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('turangfeiliao_types')">土壤肥料类型<i id="turangfeiliaoTypesIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('turangfeiliao_clicknum')">土壤肥料热度<i id="turangfeiliaoClicknumIcon" class="fa fa-sort"></i></th>
    ...
    <!-- 本表的查询条件 -->
        ...
        function setDataRow(item, number) {
            ...
            //土壤肥料编号
            var turangfeiliaoUuidNumberCell = document.createElement('td');
            turangfeiliaoUuidNumberCell.innerHTML = item.turangfeiliaoUuidNumber;
            row.appendChild(turangfeiliaoUuidNumberCell);

                //土壤肥料照片
            var turangfeiliaoPhotoCell = document.createElement('td');
            var turangfeiliaoPhotoImg = document.createElement('img');
            var turangfeiliaoPhotoImgValue = baseUrl+item.turangfeiliaoPhoto;
            if(turangfeiliaoPhotoImgValue !=null && turangfeiliaoPhotoImgValue !='' && turangfeiliaoPhotoImgValue !='null'){
                turangfeiliaoPhotoImg.setAttribute('src', turangfeiliaoPhotoImgValue);
                turangfeiliaoPhotoImg.setAttribute('height', 100);
                turangfeiliaoPhotoImg.setAttribute('width', 100);
                turangfeiliaoPhotoCell.appendChild(turangfeiliaoPhotoImg);
            }else{
                turangfeiliaoPhotoCell.innerHTML = "暂无图片";
            }
            row.appendChild(turangfeiliaoPhotoCell);

            //土壤肥料类型
            var turangfeiliaoTypesCell = document.createElement('td');
            turangfeiliaoTypesCell.innerHTML = item.turangfeiliaoValue;
            row.appendChild(turangfeiliaoTypesCell);


            //土壤肥料热度
            var turangfeiliaoClicknumCell = document.createElement('td');
            turangfeiliaoClicknumCell.innerHTML = item.turangfeiliaoClicknum;
            row.appendChild(turangfeiliaoClicknumCell);
        ...
        function upload() {
            /*导入数据*/
            /*$('#turangfeiliaoExcelFile').fileupload({
                url: baseUrl + 'file/upload',
                headers: {token: window.sessionStorage.getItem("token")},
                dataType: "json",
                done: function (e, data) {
                    http("turangfeiliao/batchInsert?fileName="+data.result.file, "get", {} , (res) => {
                        if(res.code == 0){
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("turangfeiliao/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
        ...
        function wuyong(id) {
            ...
            if (mymessage == true) {
                httpJson("turangfeiliao/update", "POST", {
                    id:id,
                    turangfeiliaoTypes:2
                }, (res) => {
                    if(res.code == 0){
                        getDataList();
                        layui.layer.msg("操作成功", {time: 2000,icon: 6});
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addturangfeiliao", "addturangfeiliao");
            window.location.href = "add-or-update.jsp"
        }
        ...
        function shangxia(id,shangxiaTypes) {
            ...
            httpJson("turangfeiliao/update", "POST", data, (res) => {
                if(res.code == 0){
