...
<!-- text后缀 -->
            <div class="layui-form-item main_borderColor" :style='{"padding":"10px","boxShadow":"0 0 0px rgba(255,0,0,.8)","margin":"0 0 10px 0","backgroundColor":"rgba(255, 255, 255, 0)","borderRadius":"1px","borderWidth":"0 0 1px 0","borderStyle":"solid"}'>
                ...
                <div class="layui-input-block">
                    <textarea class="main_borderColor layui-input" style="width: 100%;height: 100px;border-radius: 5px;padding: 10px" v-model="detail.guaguoshucaiLiuyanText" lay-verify="required" :readonly="ro.guaguoshucaiLiuyanText" name="guaguoshucaiLiuyanText" id="guaguoshucaiLiuyanText" autocomplete="off"></textarea>
                </div>
            </div>
    <!-- text后缀 -->
            <div class="layui-form-item main_borderColor" :style='{"padding":"10px","boxShadow":"0 0 0px rgba(255,0,0,.8)","margin":"0 0 10px 0","backgroundColor":"rgba(255, 255, 255, 0)","borderRadius":"1px","borderWidth":"0 0 1px 0","borderStyle":"solid"}'>
    ...
    <script>
        ...
        layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
           ...
           // 上传文件
            ...
            //修改
            if(http.getParam('guaguoshucaiLiuyanId')){
                http.request(`guaguoshucaiLiuyan/info/${http.getParam('guaguoshucaiLiuyanId')}`, 'get', {}, function(data) {
            ...
            form.on('submit(thisSubmit)', function (data) {
                ...
                if(http.getParam('guaguoshucaiLiuyanId')){
                    data["id"]= http.getParam('guaguoshucaiLiuyanId')
                }
                // 提交数据
                http.requestJson(`guaguoshucaiLiuyan/${http.getParam("guaguoshucaiLiuyanId")?"update":"add"}`, 'post', data, function (res) {
                    if(res.code == 0){
                        layer.msg('提交成功', {
                            time: 2000,
                            icon: 6
                        }, function () {
                            vue.jump("../guaguoshucaiLiuyan/list.jsp");
                                http.remove('guaguoshucaiLiuyanId')
                            // back();
                        });
                    }else{
                        layer.msg(res.msg, {
