...
public class ShuichanyangzhiCollectionView extends ShuichanyangzhiCollectionEntity implements Serializable {
	...
	*/
	...
	private String shuichanyangzhiCollectionValue;
	...
	public ShuichanyangzhiCollectionView() {

	}

	public ShuichanyangzhiCollectionView(ShuichanyangzhiCollectionEntity shuichanyangzhiCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, shuichanyangzhiCollectionEntity);
	...
	* 获取： 类型的值
	*/
	public String getShuichanyangzhiCollectionValue() {
		return shuichanyangzhiCollectionValue;
	}
	/**
	* 设置： 类型的值
	*/
	public void setShuichanyangzhiCollectionValue(String shuichanyangzhiCollectionValue) {
		this.shuichanyangzhiCollectionValue = shuichanyangzhiCollectionValue;
	}
	...
	public String toString() {
		return "ShuichanyangzhiCollectionView{" +
			", shuichanyangzhiCollectionValue=" + shuichanyangzhiCollectionValue +
