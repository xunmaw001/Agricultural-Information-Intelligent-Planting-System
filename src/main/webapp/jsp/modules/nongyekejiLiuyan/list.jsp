...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">农业科技留言管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">农业科技留言列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">农业科技留言列表</h3>
                            <div class="table-responsive mb-3" id="tableDiv">
                                <div class="col-sm-12">
                                        ...
                                        <span class="导入导出">导入<input name="file" id="nongyekejiLiuyanExcelFile" type="file" class="btn btn-success" style="width: 70px!important; line-height: 35px;"></span>
                                ...
                                <table id="tableId" class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <th onclick="sort('nongyekeji_liuyan_text')">留言内容<i id="nongyekejiLiuyanTextIcon" class="fa fa-sort"></i></th>
    ...
    <script>
        ...
        function getDataList() {
            http("nongyekejiLiuyan/page", "GET", {
                page: pageIndex,
                limit: pageSize,
                sort: sortColumn,//字段
                order: sortOrder,//asc desc
                nongyekejiLiuyanDelete: 1,
                //本表的
            //级联表的
        ...
        function setDataRow(item, number) {
            ...
            //留言内容
            var nongyekejiLiuyanTextCell = document.createElement('td');
            nongyekejiLiuyanTextCell.innerHTML = item.nongyekejiLiuyanText;
            row.appendChild(nongyekejiLiuyanTextCell);
        ...
        function upload() {
            /*导入数据*/
            /*$('#nongyekejiLiuyanExcelFile').fileupload({
                url: baseUrl + 'file/upload',
                headers: {token: window.sessionStorage.getItem("token")},
                dataType: "json",
                done: function (e, data) {
                    http("nongyekejiLiuyan/batchInsert?fileName="+data.result.file, "get", {} , (res) => {
                        if(res.code == 0){
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("nongyekejiLiuyan/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
        ...
        function wuyong(id) {
            ...
            if (mymessage == true) {
                httpJson("nongyekejiLiuyan/update", "POST", {
                    id:id,
                    nongyekejiLiuyanTypes:2
                }, (res) => {
                    if(res.code == 0){
                        getDataList();
                        layui.layer.msg("操作成功", {time: 2000,icon: 6});
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addnongyekejiLiuyan", "addnongyekejiLiuyan");
            window.location.href = "add-or-update.jsp"
        }
        ...
        function exportExcel() {
            excel = new ExcelGen({
                "src_id": "tableId",
                "show_header": true,
                "file_name": 'nongyekejiLiuyan.xlsx'
            });
            excel.generate();
        }
