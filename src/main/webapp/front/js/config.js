...
var centerMenu = [
    ...
    ,{
        name: '畜禽养殖收藏',
        url: '../chuqinyangzhiCollection/list.jsp'
    }
    ,{
        name: '瓜果蔬菜收藏',
        url: '../guaguoshucaiCollection/list.jsp'
    }
    ,{
        name: '农业科技收藏',
        url: '../nongyekejiCollection/list.jsp'
    }
    ,{
        name: '水产养殖收藏',
        url: '../shuichanyangzhiCollection/list.jsp'
    }
    ,{
        name: '土壤肥料收藏',
        url: '../turangfeiliaoCollection/list.jsp'
    }
...
var indexNav = [
    ...
    {
        name: '瓜果蔬菜',
        url: './pages/guaguoshucai/list.jsp'
    },
    {
        name: '畜禽养殖',
        url: './pages/chuqinyangzhi/list.jsp'
    },
    {
        name: '水产养殖',
        url: './pages/shuichanyangzhi/list.jsp'
    },
    {
        name: '土壤肥料',
        url: './pages/turangfeiliao/list.jsp'
    },
    {
        name: '农业科技',
        url: './pages/nongyekeji/list.jsp'
    },

]

// 已废弃,不用了
var adminurl =  "http://localhost:8080/zhinenghuazhongzhi/admin/dist/index.jsp#/login";
