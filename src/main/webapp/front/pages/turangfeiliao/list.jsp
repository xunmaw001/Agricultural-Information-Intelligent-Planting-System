...
<div class="item-list">
    ...
    <input type="text" v-model="searchForm.turangfeiliaoName"
           ...
           class="layui-input">
                ...
                <button v-if="isAuth('turangfeiliao','新增')"
                        @click="jump('../turangfeiliao/add.jsp')"
                    ...
                    <div>
                        <div style="display: flex;flex-wrap: wrap;">
                            <div v-for="(item,index) in dataList" class="list-item4 list-item3B">
                                <a @click="jumpCheck('../turangfeiliao/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)" style="margin-top:0;">
                                    <div class="hovereffect">
                                        <img :src="item.turangfeiliaoPhoto?baseUrl+item.turangfeiliaoPhoto.split(',')[0]:''" alt="" style="display: block;position: relative;width:250px;height: 280px;" />
                                        <div class="overlay">
                                            <p class="info">{{item.turangfeiliaoName}}</p>
                                        </div>
                                    </div>
                                </a>
                            </div>
