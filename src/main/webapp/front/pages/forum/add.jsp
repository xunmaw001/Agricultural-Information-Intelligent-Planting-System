            ...
            <div class="layui-form-item main_borderColor"
                ...
                <div class="layui-input-block">
                    <select name="forumTypes" id="forumTypes" lay-filter="forumTypes">
                        ...
                        <option v-for="(item,index) in forumTypesList" v-bind:key="index" :value="item.codeIndex"
                                :selected="detail.forumTypes == item.codeIndex?true:false" :key="item.codeIndex">{{
                            item.indexName }}
                        </option>
                    </select>
                </div>
