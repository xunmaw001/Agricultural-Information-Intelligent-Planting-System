                        ...
                        <div class="widget-area-2 lochana-box-shadow">
                            ...
                            <div class="table-responsive mb-3" id="tableDiv">
                                <div class="col-sm-12">
                                        ...
                                        <label>帖子类型</label>
                                        <select name="forumTypesSelectSearch" id="forumTypesSelectSearch" aria-controls="tableId" class="form-control form-control-sm"></select>
                                        ...
                                        <span class="导入导出">导入<input name="file" id="forumExcelFile" type="file" class="btn btn-success" style="width: 70px!important; line-height: 35px;"></span>
...
<!--                                        <th>帖子内容</th>-->
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            if( forumNameSearchInput != null){
                ...
                //帖子类型
            var forumTypesSelectSearchInput = document.getElementById("forumTypesSelectSearch");
            if(forumTypesSelectSearchInput != null){
                var forumTypesIndex = forumTypesSelectSearchInput.selectedIndex;
                if( forumTypesIndex  != 0){
                    searchForm.forumTypes= document.getElementById("forumTypesSelectSearch").options[forumTypesIndex].value;
                }
            }
                            getDataList();
        }
        ...
        function getDataList() {
            http("forum/list", "GET", {
                ...
                forumTypes: searchForm.forumTypes,
                forumStateTypes: 1,
            //级联表的
    ...
    //填充本表搜索下拉框
        ...
        function forumTypesSelectSearch() {
            var forumTypesSelectSearch = document.getElementById('forumTypesSelectSearch');
            if(forumTypesSelectSearch != null) {
                forumTypesSelectSearch.add(new Option('-请选择-',''));
                if (forumTypesOptions != null && forumTypesOptions.length > 0){
                    for (var i = 0; i < forumTypesOptions.length; i++) {
                            forumTypesSelectSearch.add(new Option(forumTypesOptions[i].indexName,forumTypesOptions[i].codeIndex));
                    }
                }
            }
        }
