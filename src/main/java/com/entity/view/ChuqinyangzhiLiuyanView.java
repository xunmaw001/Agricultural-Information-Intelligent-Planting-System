...
public class ChuqinyangzhiLiuyanView extends ChuqinyangzhiLiuyanEntity implements Serializable {
	...
	public ChuqinyangzhiLiuyanView() {

	}

	public ChuqinyangzhiLiuyanView(ChuqinyangzhiLiuyanEntity chuqinyangzhiLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, chuqinyangzhiLiuyanEntity);
	...
	public String toString() {
		return "ChuqinyangzhiLiuyanView{" +
