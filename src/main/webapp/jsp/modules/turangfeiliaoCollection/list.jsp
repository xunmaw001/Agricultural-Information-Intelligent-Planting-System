...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">土壤肥料收藏管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">土壤肥料收藏列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">土壤肥料收藏列表</h3>
                            <div class="table-responsive mb-3" id="tableDiv">
                                <div class="col-sm-12">
                                        ...
                                        <span class="导入导出">导入<input name="file" id="turangfeiliaoCollectionExcelFile" type="file" class="btn btn-success" style="width: 70px!important; line-height: 35px;"></span>
                                ...
                                <table id="tableId" class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <th>土壤肥料照片<i id="turangfeiliaoPhotoIcon"></i></th>
                                        <th>土壤肥料类型<i id="turangfeiliaoTypesIcon"></i></th>
                                        <th>用户姓名<i id="yonghuNameIcon"></i></th>
                                        <th onclick="sort('turangfeiliao_collection_types')">类型<i id="turangfeiliaoCollectionTypesIcon" class="fa fa-sort"></i></th>
    ...
    <script>
        ...
        function getDataList() {
            http("turangfeiliaoCollection/page", "GET", {
                page: pageIndex,
                limit: pageSize,
                sort: sortColumn,//字段
                order: sortOrder,//asc desc
                turangfeiliaoCollectionDelete: 1,
                //本表的
        ...
        function setDataRow(item, number) {
            ...
            //类型
            var turangfeiliaoCollectionTypesCell = document.createElement('td');
            turangfeiliaoCollectionTypesCell.innerHTML = item.turangfeiliaoCollectionValue;
            row.appendChild(turangfeiliaoCollectionTypesCell);
        ...
        function upload() {
            /*导入数据*/
            /*$('#turangfeiliaoCollectionExcelFile').fileupload({
                url: baseUrl + 'file/upload',
                headers: {token: window.sessionStorage.getItem("token")},
                dataType: "json",
                done: function (e, data) {
                    http("turangfeiliaoCollection/batchInsert?fileName="+data.result.file, "get", {} , (res) => {
                        if(res.code == 0){
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("turangfeiliaoCollection/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
        ...
        function wuyong(id) {
            ...
            if (mymessage == true) {
                httpJson("turangfeiliaoCollection/update", "POST", {
                    id:id,
                    turangfeiliaoCollectionTypes:2
                }, (res) => {
                    if(res.code == 0){
                        getDataList();
                        layui.layer.msg("操作成功", {time: 2000,icon: 6});
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addturangfeiliaoCollection", "addturangfeiliaoCollection");
            window.location.href = "add-or-update.jsp"
        }
        ...
        function exportExcel() {
            excel = new ExcelGen({
                "src_id": "tableId",
                "show_header": true,
                "file_name": 'turangfeiliaoCollection.xlsx'
            });
            excel.generate();
        }
