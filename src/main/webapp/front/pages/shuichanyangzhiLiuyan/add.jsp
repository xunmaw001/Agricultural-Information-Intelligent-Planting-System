...
<!-- text后缀 -->
            <div class="layui-form-item main_borderColor" :style='{"padding":"10px","boxShadow":"0 0 0px rgba(255,0,0,.8)","margin":"0 0 10px 0","backgroundColor":"rgba(255, 255, 255, 0)","borderRadius":"1px","borderWidth":"0 0 1px 0","borderStyle":"solid"}'>
                ...
                <div class="layui-input-block">
                    <textarea class="main_borderColor layui-input" style="width: 100%;height: 100px;border-radius: 5px;padding: 10px" v-model="detail.shuichanyangzhiLiuyanText" lay-verify="required" :readonly="ro.shuichanyangzhiLiuyanText" name="shuichanyangzhiLiuyanText" id="shuichanyangzhiLiuyanText" autocomplete="off"></textarea>
                </div>
            </div>
    <!-- text后缀 -->
            <div class="layui-form-item main_borderColor" :style='{"padding":"10px","boxShadow":"0 0 0px rgba(255,0,0,.8)","margin":"0 0 10px 0","backgroundColor":"rgba(255, 255, 255, 0)","borderRadius":"1px","borderWidth":"0 0 1px 0","borderStyle":"solid"}'>
    ...
    <script>
        ...
        var vue = new Vue({
            ...
            data: {
                ...
                ro:{
                    ...
                    yonghuId: false,
                    shuichanyangzhiLiuyanText: false,
                    insertTime: false,
                    replyText: false,
                    updateTime: false,
                    createTime: false,
        ...
        layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
            ...
            localStorage.setItem("goUtl","./pages/shuichanyangzhiLiuyan/list.jsp")
           ...
           // 上传文件
            ...
            //修改
            if(http.getParam('shuichanyangzhiLiuyanId')){
                http.request(`shuichanyangzhiLiuyan/info/${http.getParam('shuichanyangzhiLiuyanId')}`, 'get', {}, function(data) {
            ...
            form.on('submit(thisSubmit)', function (data) {
                ...
                if(http.getParam('shuichanyangzhiLiuyanId')){
                    data["id"]= http.getParam('shuichanyangzhiLiuyanId')
                }
                // 提交数据
                http.requestJson(`shuichanyangzhiLiuyan/${http.getParam("shuichanyangzhiLiuyanId")?"update":"add"}`, 'post', data, function (res) {
                    if(res.code == 0){
                        layer.msg('提交成功', {
                            time: 2000,
                            icon: 6
                        }, function () {
                            vue.jump("../shuichanyangzhiLiuyan/list.jsp");
                                http.remove('shuichanyangzhiLiuyanId')
                            // back();
                        });
                    }else{
                        layer.msg(res.msg, {
