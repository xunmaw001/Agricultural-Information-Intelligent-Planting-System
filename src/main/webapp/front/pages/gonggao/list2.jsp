            ...
            <table class="layui-table" lay-skin="nob">
                ...
                <tbody>
                    <tr v-for="(item,index) in dataList" v-bind:key="index">
                        ...
                        <td><button v-if="item.gonggaoContent!=null&&item.gonggaoContent!=''" @click="showContent(item.gonggaoContent)" type="button" class="layui-btn layui-btn-success">点击查看</button></td>
                        ...
                        <!--
                            ...
                            <button @click="gonggaoModal = true" type="button" class="layui-btn layui-btn-sm layui-btn-radius layui-btn-warm">
