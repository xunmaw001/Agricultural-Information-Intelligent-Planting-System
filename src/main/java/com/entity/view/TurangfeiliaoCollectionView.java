...
*/
@TableName("turangfeiliao_collection")
public class TurangfeiliaoCollectionView extends TurangfeiliaoCollectionEntity implements Serializable {
	...
	*/
	...
	private String turangfeiliaoCollectionValue;
	...
	public TurangfeiliaoCollectionView() {

	}

	public TurangfeiliaoCollectionView(TurangfeiliaoCollectionEntity turangfeiliaoCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, turangfeiliaoCollectionEntity);
	...
	* 获取： 类型的值
	*/
	public String getTurangfeiliaoCollectionValue() {
		return turangfeiliaoCollectionValue;
	}
	/**
	* 设置： 类型的值
	*/
	public void setTurangfeiliaoCollectionValue(String turangfeiliaoCollectionValue) {
		this.turangfeiliaoCollectionValue = turangfeiliaoCollectionValue;
	}
	...
	public String toString() {
		return "TurangfeiliaoCollectionView{" +
			", turangfeiliaoCollectionValue=" + turangfeiliaoCollectionValue +
