...
public class NongyekejiLiuyanEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public NongyekejiLiuyanEntity() {

	}

	public NongyekejiLiuyanEntity(T t) {
		try {
    ...
    public String toString() {
        return "NongyekejiLiuyan{" +
            ", id=" + id +
            ", nongyekejiId=" + nongyekejiId +
            ", yonghuId=" + yonghuId +
            ", nongyekejiLiuyanText=" + nongyekejiLiuyanText +
