            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">畜禽养殖类型管理</li>
                        <li class="breadcrumb-item active">编辑畜禽养殖类型</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">畜禽养殖类型表信息</h3>
...
<script>
    ...
    var tableName = "dictionaryChuqinyangzhi";
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            data["dicCode"] = "chuqinyangzhi_types";
            data["dicName"] = "畜禽养殖类型";
    ...
    function getDetails() {
        ...
        if (adddictionary != null && adddictionary != "" && adddictionary != "null") {
            ...
            $(validform());
            $('#submitBtn').text('新增');
            httpJson("dictionary/maxCodeIndex" , "POST", {"dicCode":"chuqinyangzhi_types"}, (res) => {
                if(res.code == 0){
