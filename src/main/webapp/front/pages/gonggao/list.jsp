...
<div class="item-list">
    ...
    <input type="text" v-model="searchForm.gonggaoName"
           ...
           class="layui-input">
                        ...
                        type="button" class="layui-btn layui-btn-normal sub_backgroundColor">
                    <i v-if="true" class="layui-icon layui-icon-search"></i>搜索
                </button>
                <button v-if="isAuth('gonggao','新增')"
                        @click="jump('../gonggao/add.jsp')"
                        :style='{"padding":"0 15px","boxShadow":"0 0 8px rgba(0,0,0,0)","margin":"0 0 0 10px","borderColor":"rgba(135, 206, 250, 1)","backgroundColor":"rgba(135, 206, 250, 1)","color":"#fff","borderRadius":"4px","borderWidth":"0","width":"auto","fontSize":"14px","borderStyle":"solid","height":"40px"}'
                        type="button" class="layui-btn btn-theme">
                    <i v-if="true" class="layui-icon">&#xe654;</i>添加
                </button>
        </form>
                            <div style="display:flex;flex-direction: column;">
                <div @click="jump('../gonggao/detail.jsp?id='+item.id);" v-for="(item,index) in dataList" :key="index" style="display:flex;flex-direction: column;align-items: flex-start" class="animation-box"
                     :style='{"padding":"12px","boxShadow":"10px -10px 0px 0px var(--publicSubColor)","margin":"20px 0 10px 5%","borderColor":"var(--publicSubColor)","backgroundColor":"#fff","borderRadius":"0 40px 0 0","borderWidth":"2px","borderStyle":"solid","height":"auto"}'>
                    <div>
                        <div :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","color":"#333","borderRadius":"0","borderWidth":"0","width":"auto","lineHeight":"24px","fontSize":"18px","borderStyle":"solid"}'>{{item.gonggaoName}}</div>
                        <div :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","color":"#333","borderRadius":"0","borderWidth":"0","width":"auto","lineHeight":"24px","fontSize":"14px","borderStyle":"solid"}'>{{item.insertTime}}</div>
                    </div>
                    <div style="overflow: hidden;display: -webkit-box;-webkit-line-clamp: 3; -webkit-box-orient: vertical;"  :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"10px 0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","color":"#666","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"28px","fontSize":"14px","borderStyle":"solid"}' v-html="myFilters(item.gonggaoContent)"></div>
                    <div :style='{"padding":"0 12px","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"var(--publicMainColor)","color":"#fff","borderRadius":"4px","borderWidth":"0","lineHeight":"24px","fontSize":"12px","borderStyle":"solid"}'>{{item.gonggaoValue}}</div>
                </div>
            </div>        </div>
